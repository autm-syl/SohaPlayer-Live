...
- (instancetype)initWithConfiguration:(SHPlayerConfig *)configuration;

- (instancetype)initWithConfiguration:(SHPlayerConfig *)configuration webRq:(BOOL)webRq;
...
- (void)addSHPlayerEventListener:(NSString *)event eventID:(NSString *)eventID handler:(void(^)(NSString *eventName, NSString *params))handler;
...
@property (nonatomic) BOOL autoRelease;
